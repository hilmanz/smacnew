...
if($num > 0){
	...
	foreach($rs as $r){
			...
			$xml.="<name>".utf8tohtml($r['author_name'])."</name>\n";			
			//$xml.="<txtraw><![CDATA[".html_entity_decode(utf8_encode($r['content']))."]]></txtraw>\n";
			//$xml.="<txtraw><![CDATA[".html_entity_decode(utf8_decode($r['content']))."]]></txtraw>\n";
			//$xml.="<txthex><![CDATA[".html_entity_decode(strToHex($r['content']))."]]></txthex>\n";
			//$xml.="<txt><![CDATA[".html_entity_decode(utf8tohtml($r['content']))."]]></txt>\n";

...
if($CONFIG['DEVELOPMENT']){
	$CONFIG['DATABASE'][0]['HOST']   	= "202.80.113.116";
...
$CONFIG['BASEURL'] = "http://".$_SERVER['HTTP_HOST']."/smac_trunk/web/public_html/";
$CONFIG['ACTIVATION_URL'] = "http://dev.smac.me/public_html/";
/* API BASEURL */
$CONFIG['API_BASEURL'] = "http://localhost/smac_trunk/web/api/";
$CONFIG['MARKET_API_BASEURL'] = "http://localhost/smac_trunk/web/api2/";
...
//Facebook API
$FACEBOOK['APP_ID'] = "112801195539086";
$FACEBOOK['APP_SECRET'] = "0346f9f34312d82e31a535e3fc796a09";
//-->

/**
 * Topic Cost
 */
$CONFIG['ACCOUNT_COST'] = array("0"=>0,"1"=>450,"2"=>450,"3"=>350,"4"=>250);

/**
 * Paypal
 */
$PAYPAL['returnUrl'] = "http://localhost/experiment/paypal-merchant-php-1.2.95/return.php";
$PAYPAL['cancelUrl'] = "http://localhost/experiment/paypal-merchant-php-1.2.95/cancel.php";
$PAYPAL['redirection_url'] = "https://www.sandbox.paypal.com/webscr?cmd=_express-checkout";
?>

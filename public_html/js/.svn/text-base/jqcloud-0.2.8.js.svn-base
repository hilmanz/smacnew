 ...
 *
 * Date: Tue Nov 22 23:54:02 +0100 2011
*/ 
      ...
      var drawOneWord = function(index, word) {
        ...
        var word_id = container_id + "_word_" + index,
          ...
          (($.isArray(options.randomClasses) && options.randomClasses.length > 0) ?
            ...
            word_span = $('<span>').attr('id',word_id).attr('class','w' + weight).addClass('stats'+ cColor).addClass(random_class).addClass(word.custom_class||null).attr('title', word.title || word.text || ''),
            inner_html;
